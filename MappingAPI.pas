...
function GetMappedMemory(MappingName: string; Size: LongWord): Pointer; overload;
function GetMappedMemory(MappingObject: THandle; Size: LongWord): Pointer; overload;
